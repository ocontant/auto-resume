...
@pytest.mark.asyncio
async def test_update_education_field_endpoint_not_found(client: TestClient, mock_update_education_field_not_found):
...
@pytest.mark.asyncio
async def test_update_experience_field_endpoint_not_found(client: TestClient, mock_update_experience_field_not_found):
    """Test PATCH experience field returns 404 if not found."""
    pass


@pytest.mark.asyncio
async def test_update_experience_field_endpoint_server_error(client: TestClient, mock_update_experience_field_error):
...
@pytest.mark.asyncio
async def test_update_project_point_endpoint_out_of_range(client: TestClient, mock_update_project_point_out_of_range):
...
@pytest.mark.asyncio
async def test_add_education_endpoint_server_error(client: TestClient, mock_add_education_error, mock_get_or_create_resume):
...
@pytest.mark.asyncio
async def test_add_project_endpoint_server_error(client: TestClient, mock_add_project_error, mock_get_or_create_resume):
...
@pytest.mark.asyncio
async def test_add_experience_endpoint_server_error(client: TestClient, mock_add_experience_error, mock_get_or_create_resume):
